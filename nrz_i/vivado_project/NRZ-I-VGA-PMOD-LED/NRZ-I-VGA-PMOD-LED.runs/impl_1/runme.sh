...
HD_PWD='C:/Users/081230010/Documents/Projeto_NRZ_L/Projeto_NRZ_L/Projeto_NRZ_L/Projeto_NRZ_L/Projeto_NRZ_L.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nrz_l_modulator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nrz_l_modulator.tcl -notrace
